...
select c5.c5_cliente,c5.c5_lojaent,c5.* from sc5010 c5 where c5.c5_filial='0301' and c5.c5_num='208485';

--VERIFICAR CADASTROS DE CLIENTE/FORNECEDO
select a1.d_e_l_e_t_,decode(a1.a1_msblql,'1','SIM','NAO') as bloqueado,a1.a1_cgc,a1.a1_inscr,a1.* from sa1010 a1 where a1.a1_cod='125723141';
select a2.d_e_l_e_t_,decode(a2.a2_msblql,'1','SIM','NAO') as bloqueado,a2.a2_cgc,a2.a2_inscr,a2.* from sa2010 a2 where a2.a2_cod='125723141';

--CADASTRO DA TRANSPORTADORA ASSOCIADA NA CARGA
select a4.a4_msblql,a4.a4_cgc,a4.a4_insest,a4.* from sa4010 a4 where 
a4.a4_cgc='12572314134'; --pesqueisar pelo CPG/CNPJ completo
--a4_cod='008655';

--21079708000230	352/0004820       

--CADASTRO DE EMITENTE
select gu3.d_e_l_e_t_,decode(gu3.d_e_l_e_t_,'*','SIM','NAO') as deletado,gu3.r_e_c_n_o_, gu3.gu3_idfed as CPF_CNPJ,gu3.gu3_ie as Inscr_Est, gu3.gu3_cderp as cod_A1_A2,
...
from gu3010 gu3 where gu3.gu3_idfed='12572314134' and gu3.d_e_l_e_t_=' ' order by gu3.gu3_cdcerp;
...
update gu3010 gu3 set gu3.d_e_l_e_t_='*',gu3.r_e_c_d_e_l_=gu3.r_e_c_n_o_ where gu3.r_e_c_n_o_=18195;
