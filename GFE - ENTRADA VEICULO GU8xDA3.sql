...
select a.r_e_c_n_o_,D_E_L_E_T_,a.* from DA4010 a where DA4_CGC in ('02692009169');
...
--update da4010 set DA4_NOME=DA4_NREDUZ where r_e_c_n_o_=14326;
--select D_E_L_E_T_,a.* from DA4010 a where DA4_nome like '%CAIRO%';
--select D_E_L_E_T_,a.* from DA3010 a where DA3_PLACA='BCQ5851';

select a.r_e_c_n_o_,d_e_l_e_t_,GUU_SIT,GUU_DTSIT,NVL(trim(GUU_DSSIT),' ')GUU_DSSIT,a.* from GUU010 a where GUU_IDFED in ('02692009169');
update GUU010 set GUU_SIT=1 where GUU_IDFED in ('02692009169');
