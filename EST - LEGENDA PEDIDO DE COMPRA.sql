...
select C7_QTDACLA,C7_RESIDUO,C7_CONTRA,C7_CONAPRO,a.* from sc7010 a where c7_filial='0301' and c7_num='445294';

select d_e_l_e_t_,d1_doc,d1_pedido,d1_tes,d1_fornece,a.* from sd1010 a where d1_pedido='445294';
...
select C7_QUJE,C7_QTDACLA,C7_RESIDUO,C7_CONTRA,C7_CONAPRO,a.* from sc7010 a where c7_filial='0301' and c7_num='445294';
/* C7_QUJE==0 .And. C7_QTDACLA==0.And.Empty(C7_RESIDUO).AND.Empty(C7_CONTRA).AND. C7_CONAPRO<>"B" */
update sc7010 set C7_QUJE=0,C7_QTDACLA=0,C7_RESIDUO=' ' ,C7_CONTRA=' ' where c7_filial='0301' and c7_num='445294';
