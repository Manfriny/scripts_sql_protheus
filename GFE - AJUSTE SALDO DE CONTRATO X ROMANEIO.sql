...
select njp_qtdfco,njp_qtdfis,a.* from njp010 a where njp_filial='0302' and njp_codctr='000712' and njp_item='007' and d_e_l_e_t_=' ';

--Ajusto a Qtd Fisica e o Qtd Saldo Aut conforme quant correta informada pela Comercialização
update njp010 set njp_qtdfco=(njp_qtdfco-65820),njp_qtdfis=(njp_qtdfis-65820) where njp_filial='0302' and njp_codctr='000712' and njp_item='007' and d_e_l_e_t_=' ';
