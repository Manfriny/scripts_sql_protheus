...
select gx3.gx3_sit,gx3.* from GX3010 gx3 where gx3.gx3_filial='0301' and gx3.gx3_nrmov='00026369'; -- sit tem que ser = 5 (1-aberto; 2-movimentado; 3-em fila; 4-endereçado; 5-cancelado; 6-concluido)
update gwv010 set GWV_NRROM=' ' where gwv_filial='0301' and gwv_nrmov='00026369';
select gwv_nrmov,gwv.gwv_sit,GWV_NRROM,gwv.* from gwv010 gwv where GWV_FILIAL='0301' and gwv_nrmov='00026369';
